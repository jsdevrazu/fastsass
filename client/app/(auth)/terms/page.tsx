      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <TermsCard
            ...
            title="Agreement"
            description="These terms constitute a legally binding agreement between you and FastSass."
          />
          <TermsCard
        ...
        <div className="space-y-8 mb-12">
          ...
          <TermsSection
            ...
            content={`
              <p>Welcome to FastSass. These Terms of Service ("Terms") govern your access to and use of the FastSass website, mobile applications, and services (collectively, the "Services").</p>
              ...
              <p>Please read these Terms carefully, as they contain important information about your legal rights, remedies, and obligations. By using our Services, you are entering into a legal contract with FastSass, Inc.</p>
            `}
          />
          ...
          <TermsSection
            ...
            content={`
              ...
              <ul class="list-disc pl-6 space-y-2 mt-2">
                <li><strong>"FastSass"</strong> (or "we," "our," or "us") refers to FastSass, Inc., the company that operates the Services.</li>
          ...
          <TermsSection
            ...
            content={`
              ...
              <p>You are responsible for safeguarding your account credentials and for any activity that occurs under your account. You agree to notify FastSass immediately of any unauthorized use of your account or any other breach of security. FastSass will not be liable for any losses caused by any unauthorized use of your account.</p>
              ...
              <p>You may not create or maintain more than one account for the same purpose. FastSass reserves the right to terminate duplicate accounts without notice.</p>
            `}
          />
          ...
          <TermsSection
            ...
            content={`
              ...
              <p>You retain all ownership rights in the User Content you post to our Services. By posting User Content, you grant FastSass a worldwide, non-exclusive, royalty-free license (with the right to sublicense) to use, copy, reproduce, process, adapt, modify, publish, transmit, display, and distribute such User Content in any and all media or distribution methods now known or later developed.</p>
              ...
              <ul class="list-disc pl-6 space-y-1 mt-1">
                <li>You own or have the necessary rights to use and authorize FastSass to use your User Content;</li>
              ...
              <p><strong>5.3 FastSass Content</strong></p>
              <p>The Services contain Content owned or licensed by FastSass ("FastSass Content"). FastSass Content is protected by copyright, trademark, patent, trade secret, and other laws, and FastSass owns and retains all rights in the FastSass Content and the Services. You may not remove, alter, or conceal any copyright, trademark, service mark, or other proprietary rights notices incorporated in or accompanying the FastSass Content.</p>
              
              <p><strong>5.4 Content Monitoring</strong></p>
              <p>FastSass has the right, but not the obligation, to monitor and edit all Content provided by Users. FastSass reserves the right to remove any Content that violates these Terms or that we find objectionable for any reason, without prior notice.</p>
            `}
          />
          ...
          <TermsSection
            ...
            content={`
              ...
              <p>FastSass provides a platform that connects Job Seekers with Employers. Our Services include job posting, resume posting, job search, candidate search, and related features.</p>
              
              <p><strong>6.2 Free and Paid Services</strong></p>
              <p>Some of our Services are offered free of charge, while others require payment. FastSass reserves the right to modify, terminate, or otherwise amend our offered Services and fee structure at any time.</p>
              ...
              <p>Some of our Services may be offered on a subscription basis. By signing up for a subscription, you authorize FastSass to charge your payment method on a recurring basis until you cancel. You may cancel your subscription at any time by following the instructions in your account settings.</p>
            `}
          />
          ...
          <TermsSection
            ...
            content={`
              ...
              <p>You may terminate your account at any time by following the instructions in your account settings or by contacting us at support@FastSass.com.</p>
              
              <p><strong>7.2 Termination by FastSass</strong></p>
              <p>FastSass reserves the right to suspend or terminate your account and access to the Services at any time for any reason, including, but not limited to, your violation of these Terms. FastSass may also terminate or suspend your access to the Services without prior notice if we believe that such action is necessary to protect the safety or interests of FastSass, its Users, or third parties.</p>
              
              <p><strong>7.3 Effect of Termination</strong></p>
              <p>Upon termination of your account, your right to use the Services will immediately cease, and FastSass may delete or remove any Content associated with your account. All provisions of these Terms that by their nature should survive termination shall survive termination, including, without limitation, ownership provisions, warranty disclaimers, indemnity, and limitations of liability.</p>
            `}
          />
          ...
          <TermsSection
            ...
            content={`
              ...
              <p>THE SERVICES ARE PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. FastSass DOES NOT WARRANT THAT THE SERVICES WILL BE UNINTERRUPTED OR ERROR-FREE, THAT DEFECTS WILL BE CORRECTED, OR THAT THE SERVICES OR THE SERVERS THAT MAKE THEM AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.</p>
              
              <p><strong>8.2 Third-Party Content</strong></p>
              <p>FastSass DOES NOT ENDORSE, WARRANT, OR GUARANTEE ANY THIRD-PARTY CONTENT OR SERVICES AVAILABLE THROUGH OUR SERVICES AND WILL NOT BE A PARTY TO OR IN ANY WAY RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES.</p>
              
              <p><strong>8.3 Limitation of Liability</strong></p>
              <p>IN NO EVENT SHALL FastSass, ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS, BE LIABLE TO YOU FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, OR CONSEQUENTIAL DAMAGES WHATSOEVER RESULTING FROM ANY (I) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT, (II) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF OUR SERVICES, (III) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (IV) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM OUR SERVICES, (V) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE, WHICH MAY BE TRANSMITTED TO OR THROUGH OUR SERVICES BY ANY THIRD PARTY, AND/OR (VI) ANY ERRORS OR OMISSIONS IN ANY CONTENT OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF YOUR USE OF ANY CONTENT POSTED, EMAILED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SERVICES, WHETHER BASED ON WARRANTY, CONTRACT, TORT, OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT FastSass IS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
              
              <p>THE FOREGOING LIMITATION OF LIABILITY SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW IN THE APPLICABLE JURISDICTION. YOU SPECIFICALLY ACKNOWLEDGE THAT FastSass SHALL NOT BE LIABLE FOR USER CONTENT OR THE DEFAMATORY, OFFENSIVE, OR ILLEGAL CONDUCT OF ANY THIRD PARTY AND THAT THE RISK OF HARM OR DAMAGE FROM THE FOREGOING RESTS ENTIRELY WITH YOU.</p>
            `}
          />
          ...
          <TermsSection
            ...
            content={`
              ...
              <p>Notwithstanding the foregoing, FastSass may seek injunctive or other equitable relief to protect its intellectual property rights or confidential information in any court of competent jurisdiction.</p>
              
              <p><strong>10.4 Class Action Waiver</strong></p>
              <p>ANY ARBITRATION SHALL BE CONDUCTED ON AN INDIVIDUAL BASIS. YOU AND FastSass AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE PROCEEDING.</p>
            `}
          />
          ...
          <TermsSection
            ...
            content={`
              <p>FastSass reserves the right, at its sole discretion, to modify or replace these Terms at any time. If a revision is material, we will provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.</p>
          ...
          <TermsSection
            ...
            content={`
              ...
              <p>These Terms constitute the entire agreement between you and FastSass regarding the use of the Services, superseding any prior agreements between you and FastSass relating to your use of the Services.</p>
              
              <p><strong>12.2 Waiver and Severability</strong></p>
              <p>The failure of FastSass to enforce any right or provision of these Terms will not be deemed a waiver of such right or provision. If any provision of these Terms is held to be invalid or unenforceable, such provision shall be struck and the remaining provisions shall be enforced.</p>
              
              <p><strong>12.3 Assignment</strong></p>
              <p>You may not assign or transfer these Terms, by operation of law or otherwise, without FastSass's prior written consent. Any attempt by you to assign or transfer these Terms without such consent will be null and of no effect. FastSass may assign or transfer these Terms, at its sole discretion, without restriction.</p>
              
              <p><strong>12.4 Notices</strong></p>
              <p>Any notices or other communications provided by FastSass under these Terms will be given by posting to the Services or by email to the email address you provide during registration.</p>
              
              <p><strong>12.5 Contact Information</strong></p>
              <p>If you have any questions about these Terms, please contact us at legal@FastSass.com.</p>
            `}
          />
        </div>
